...
type TrackDataService interface {
	...
	UploadTrackData(ctx context.Context, in *TrackChunk) (*TrackServerId, error)
}
...
func (c *trackDataServiceProtobufClient) UploadTrackData(ctx context.Context, in *TrackChunk) (*TrackServerId, error) {
	ctx = ctxsetters.WithPackageName(ctx, "resonate.api.trackdata")
	ctx = ctxsetters.WithServiceName(ctx, "TrackDataService")
...
func (c *trackDataServiceJSONClient) UploadTrackData(ctx context.Context, in *TrackChunk) (*TrackServerId, error) {
	ctx = ctxsetters.WithPackageName(ctx, "resonate.api.trackdata")
	ctx = ctxsetters.WithServiceName(ctx, "TrackDataService")
	ctx = ctxsetters.WithMethodName(ctx, "UploadTrackData")
	out := new(TrackServerId)
...
func (s *trackDataServiceServer) serveUploadTrackDataProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil TrackChunk and nil error while calling UploadTrackData. nil responses are not supported"))
		return
	}
